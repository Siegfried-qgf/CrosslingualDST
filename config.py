...
def add_config(parser):
    ...
    group.add_argument("-backbone", type=str, default="google/mt5-base",
                       choices=["google/mt5-small", "google/mt5-base", "google/mt5-large"])
    ...
    group.add_argument("-batch_size_per_gpu_eval", type=int, default=8)
    ...
    group.add_argument("-s_type", type=str, default="en")
    group.add_argument("-t_type", type=str, default="en")
    ...
    group.add_argument("-save_best_model", action="store_true")
